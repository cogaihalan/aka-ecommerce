...
export type CustomerLogos3Props =
  SliceComponentProps<Content.CustomerLogos3Slice>;

const CustomerLogos3: FC<CustomerLogos3Props> = ({ slice }) => {
  return (
    <section
